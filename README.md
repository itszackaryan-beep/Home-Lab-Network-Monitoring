...
![Windows Server Desktop](docs/Screenshots/fig02-windows-server-desktop-server-manager.jpg)

**Description:** Windows Server 2022 installed successfully.

**Figure 3 — Windows Version Verification**

![Windows Version Verification](docs/Screenshots/fig03-windows-version-verification-winver.jpg)
...
![Windows Server IP Configuration](docs/Screenshots/fig04-windows-server-ip-configuration.jpg)
...
![Kali Linux IP Configuration](docs/Screenshots/fig05-kali-linux-ip-configuration.jpg)
...
![Ping Test — Kali to Windows Server](docs/Screenshots/fig06-ping-test-kali-to-windows-server.jpg)
...
![Ping Test — Windows Server to Kali](docs/Screenshots/fig07-ping-test-windows-server-to-kali.jpg)
...
![ICMP Packet Capture](docs/Screenshots/fig08-icmp-packet-capture.jpg)
...
![DNS Packet Capture](docs/Screenshots/fig09-dns-packet-capture.jpg)
...
![HTTP Packet Capture](docs/Screenshots/fig10-http-packet-capture.jpg)
...
![TCP Packet Capture](docs/Screenshots/fig11-tcp-packet-capture.jpg)
...
![ARP Packet Capture](docs/Screenshots/fig12-arp-packet-capture.jpg)
...
![Protocol Hierarchy Statistics](docs/Screenshots/fig13-protocol-hierarchy-statistics.jpg)
